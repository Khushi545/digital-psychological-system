  ...
  return (
    <div className="animate-fade-in" style={{ minHeight: '100vh', backgroundColor: 'var(--bg-card)' }}>
      ...
      <div style={{ backgroundColor: 'var(--bg-main)', paddingBottom: '4rem' }}>
        <div style={{ display: 'flex', maxWidth: '1400px', margin: '0 auto', padding: '4rem 5%', alignItems: 'center', justifyContent: 'center',
alignItems: 'center',
textAlign: 'center', gap: '4rem' }}>
          ...
          <div style={{ flex: 1, maxWidth: '600px' ,margin: '0 auto'}}>
            ...
            <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', marginBottom: '3rem', lineHeight: '1.6', maxWidth: '500px', margin: '0 auto' }}>
